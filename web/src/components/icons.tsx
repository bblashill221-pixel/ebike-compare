...
// Solid thumbs-up; inherits color from `currentColor` so the caller sets the shade.
/** Lightning bolt — same shape as the logo's bolt; used for the rank tier marks. */
