...
export const FEATURE_GROUPS: { label: string; emoji: string; members: string[] }[] = [
  ...
  { label: "Premium Ride Kit", emoji: "🚲", members: ["Dual Motor", "Carbon Frame", "Dropper Post", "Dual Battery", "Quiet Motor", "Regen Braking", "ABS", "4-Piston Brakes"] },
  { label: "Safety & Alerts", emoji: "🔔", members: ["Horn / Bell"] },
];
