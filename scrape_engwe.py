#!/usr/bin/env python3
"""
ENGWE (US store, engwe-bikes.com) e-bike scraper (Shopify, products.json + page HTML).
...
def main():
    ap = argparse.ArgumentParser(description="Scrape ENGWE e-bike specifications.")
    ap.add_argument("-o", "--output", default="data/current/engwe_ebikes.json")
